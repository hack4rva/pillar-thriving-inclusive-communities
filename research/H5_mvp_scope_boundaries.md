...
| :--- | :--- | :--- | :--- |
| Privacy statement on landing | Visible on first paint without scrolling | [Owner] | Friday 5pm |
| 1 complete user flow | Landing → Category → Org → Contact works flawlessly | [Owner] | Saturday noon |
| Mobile-responsive layout | Passes testing on at least 3 different device sizes | [Owner] | Saturday 3pm |
| Honest data labeling | "Verified on [date]" badge + limitations text on each org | [Owner] | Saturday 5pm |
| 10 verified orgs | Exactly 10 records are verified, consistent, and seeded | [Owner] | Friday noon |
...
| Real-time API sync (Help1RVA) | Cut Entirely | High risk; cut if behind. |
